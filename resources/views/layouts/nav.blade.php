	...
	<div class="flex w-5/6 m-auto">
		...
		<div class="ml-auto my-auto">
			@guest
		      	<a
		      		href="{{ route('login') }}"
		      		class="text-xs font-bold py-1 px-2 border-2 rounded text-blue-600 border-blue-600 hover:border-blue-400 hover:text-blue-500 mr-2"
	      		>
		      		Log in
		      	</a>
		      	<a
			      	href="{{ route('register') }}"
			      	class="text-xs font-bold py-1 px-2 border-2 rounded bg-blue-600 text-white border-blue-600 hover:bg-blue-400 hover:border-blue-400 hover:text-blue-500"
		      	>
		      		Sign up
		      	</a>
			@else
