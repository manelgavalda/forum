        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <replies :data="{{ $thread->replies }}" @removed="repliesCount--" can-update="{{ Auth::user()->can('update', $thread) }}"></replies>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <p>
                                Thsi thread was published {{ $thread->created_at->diffForHumans() }} by
